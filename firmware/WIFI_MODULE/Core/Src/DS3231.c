...
bool DS3231_GetTime(_RTC *rtc)
{
   ...
   *  This function is used to receive data as a master device from a slave device on the I2C bus.
   *  It is a more general-purpose function for reading data from any slave device, not necessarily from a specific memory address.
   */
